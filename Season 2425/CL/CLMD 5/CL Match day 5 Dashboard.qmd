---
title: "CL Match Day 5 Season 2425"
...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 12/")

#set away
Match_Away <- paste0("Real Madrid")
...
#MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1821328/Show/England-Premier-League-2024-2025-Southampton-Liverpool")
...
Player_Summary_data_A_MOM <- Player_Summary_data_Home %>% 
  filter(Name == "Alexis Mac Allister")
...
Player_Summary_data_MOM <- Player_Summary_data_Home %>% 
  filter(Name == "Conor Bradley")
  
Player_Summary_Plot_Home <- Player_Summary_data_MOM %>% 
  ggplot() +
  geom_col(aes(x = Metric,
               y = Value,
               fill = Value), color = "gray4",
