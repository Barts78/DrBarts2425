...
Champions League Games for the **2024 - 2025** Season
::::
...
md_dirs <- md_dirs[grepl("^CLMD\\s+\\d+$", md_dirs)]
md_dirs <- md_dirs[order(as.numeric(sub("^CLMD\\s+", "", md_dirs)))]

default_thumb <- "Images/champions-league-ball.png"
...
pick_md_thumb <- function(md, base_dir = ".") {
  ...
  thumb_path <- file.path(
    ...
    md,
    #"docs",
    paste0("CL-Match-day-", md_num, "-Dashboard_files"),
    "figure-html",
