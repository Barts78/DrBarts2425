---
title: "CL Match Day 3 Season 2425"
...
#Set Home
Match_Home <- paste0("Leipzig")

#set Away color
Color_Home <- paste("white")
...
ColorScale_HomeC <- paste("ggthemes::Classic Gray")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/7acc13f8/RB-Leipzig-Liverpool-October-23-2024-Champions-League") 

#set WhoScored Match page
MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1866120/Live/Europe-Champions-League-2024-2025-RB-Leipzig-Liverpool")
...
HomepassPlot1stWD <- plot_passnet_AI(data = plottingData,
                                  ...
                                  scale_color = Color_Home_Text, text_color = Color_Home, subtitle = paste0(Match_Fixture, " 1st Half"),
...
HomepassPlot2ndWD <- plot_passnet_AI(data = plottingData,  
                                  team_name = Match_Home, scale_stat = "EPV", 
                                  scale_color = Color_Home_Text,  text_color = Color_Home, subtitle = paste0(Match_Fixture, " 2nd Half"),
...
HomepassPlot1stsubsWD <- plot_passnet_AI(data = plottingData, 
                                   team_name = Match_Home, scale_stat = "EPV", 
                                   scale_color = Color_Home_Text, text_color = Color_Home, subtitle = paste0(Match_Fixture, " To 1st Subs"),
...
HomepassPlotPost1stsubsWD <- plot_passnet_AI(data = plottingData, 
                                        team_name = Match_Home, scale_stat = "EPV", 
                                        scale_color = Color_Home_Text,  text_color = Color_Home, subtitle = paste0(Match_Fixture, " Post 1st Subs"),
...
#geometrics
  geom_line(size = 1.5, colour = Color_Home_Text) +
...
# Line Plot
  ...
  #Geometrics
  #xg line
  geom_line(aes(x = expandedMinute, y = TotalxG), linewidth = 2, colour = Color_Home_Text) +
  
  #npXg line
  geom_line(aes(x = expandedMinute, y = TotalNPxG), linewidth = 1, colour = Color_Home_Text, linetype = "dashed") +
