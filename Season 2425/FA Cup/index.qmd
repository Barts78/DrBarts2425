...
FA Cup Games for the **2024 - 2025** Season
::::
...
md_dirs <- md_dirs[grepl("^FACMD\\s+\\d+$", md_dirs)]
md_dirs <- md_dirs[order(as.numeric(sub("^FACMD\\s+", "", md_dirs)))]
...
pick_md_thumb <- function(md, base_dir = ".") {
  ...
  if (file.exists(thumb_path)) {
    ...
    "Images/fa_cup_ball.png"   # fallback
  }
}
