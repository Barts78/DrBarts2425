---
title: "FACUP Match Day R4 Season 2425"
...
Vizlocation <- paste0("~/Dropbox/AI LFC data/R files/AI UP/Scripts/Viz Pack/Season 2425/FACUP R4/")
...
#Set Home
Match_Home <- paste0("Plymouth")

#set Home color
Color_Home <- paste("green4")

#set home text color
Color_Home_Text <- paste("black")

#set home color scale
ColorScale_Home <- paste("ggsci::green_material")

#set home color scale con
ColorScale_HomeC <- paste("ggthemes::Classic Green")

#set match date
Game_date <- paste("09-02-25")
