---
title: "Match Day 26 Season 2425"
...
#Set Home
Match_Home <- paste0("Manchester City")

#set Home color
Color_Home <- paste("#29B6F6")

#set home text color
Color_Home_Text <- paste("ivory")

#set home color scale
ColorScale_Home <- paste("ggsci::light_blue_material")

#set home color scale con
ColorScale_HomeC <- paste("ggthemes::Blue Light")

#set match date
Game_date <- paste("23-02-25")
...
#set league points
League_Points <- 64
AFC_League_Points <- 53
MC_League_Points <- 44

#set man of the match
HMOM = paste("Omar Marmoush")
AMOM = paste("Mohamed Salah")
