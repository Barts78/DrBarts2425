---
title: "Match Day 25 Season 2425"
...
Vizlocation <- paste0("~/Dropbox/AI LFC data/R files/AI UP/Scripts/Viz Pack/Season 2425/MD25/")

#set away
Match_Away <- paste0("Wolverhampton Wanderers")

#set Away color
Color_Away <- paste("gold2")

#set Away text
Color_Away_Text <- paste("black")

#set away color scale
ColorScale_Away <- paste("ggsci::amber_material") 

#set away color scale con
ColorScale_AwayC <- paste("ggthemes::Orange-Gold")
