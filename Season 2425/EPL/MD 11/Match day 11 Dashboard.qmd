---
title: "Match Day 11 Season 2425"
...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 11/")

#set away
Match_Away <- paste0("Aston Villa")

#set Away color
Color_Away <- paste("#00CDCD")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/737af5bf/Liverpool-Aston-Villa-November-9-2024-Premier-League") 

#set WhoScored Match page
MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1821266/Live/England-Premier-League-2024-2025-Liverpool-Aston-Villa")
...
#load fbref Data
#set files names
#filenamefbref1 <- paste0("~/Dropbox/AI LFC data/data sets/fbref/", GameName, "_", GameWeek, "_Passing_values_EPL2425.xlsx")
#filenamefbref2 <- paste0("~/Dropbox/AI LFC data/data sets/fbref/", GameName, "_", GameWeek, "_Shots_EPL2425.xlsx")
#filenamefbref3 <- paste0("~/Dropbox/AI LFC data/data sets/fbref/", GameName, "_", GameWeek, "_Shots_values_EPL2425.xlsx")

#set data basis for some tables
#MD_passing_values <- read_excel(filenamefbref1)
#MD_shots <- read_excel(filenamefbref2)
#MD_shot_values <- read_excel(filenamefbref3) 
```
