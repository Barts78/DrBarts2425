...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 2/")

#set Away
Match_Away <- paste0("Brentford")

#set Away color
Color_Away <- paste("pink")
...
ColorScale_Away <- paste("ggsci::pink_material") 

#set home color scale con
ColorScale_HomeC <- paste("ggthemes::Red")

#set away color scale con
ColorScale_AwayC <- paste("ggthemes::Purple")

#set match date
Game_date <- paste("25-08-24")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/09b1742e/Liverpool-Brentford-August-25-2024-Premier-League") 

#set WhoScored Match page
MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1821064/Live/England-Premier-League-2024-2025-Liverpool-Brentford")
