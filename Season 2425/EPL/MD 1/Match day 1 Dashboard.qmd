...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 1/")

#set dashboard directory
Dashlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 1/Viz Pack/")

#set Away
Match_Away <- paste("Liverpool")

#set Away color
Color_Away <- paste("#d3171e")

#set Away text
Color_Away_Text <- paste("white")

#Set Home
Match_Home <- paste("Ipswich Town")

#set Home color
Color_Home <- paste("#0333A0")
...
#Set Fotmob Match ID
MatchIdFotmob <- 4506264 #check

#set Fotmob Home / home team ID
HomeIdFotmob <- 9902 

#set Fotmob Away / away team ID
AwayIdFotmob <- 8650

#set fbref match page
MatchIdFbref <- paste("https://fbref.com/en/matches/a1d0d529/Ipswich-Town-Liverpool-August-17-2024-Premier-League") #check
...
GameNamePlayers <- paste(GameName, "_players")
...
#load in Fotmob for shooting data
fileName3 <- paste0("~/Dropbox/AI lfc data/data sets/fotmob/", GameName, "_", GameWeek, "_Shots_EPL2425.xlsx")
EPL_FotMob_shots_EPL2425 <- read_excel(fileName3)
...
MD_logos <- MD_lineups %>%
  mutate(Pos = case_when(Pos == "FW" ~ "Attacker",
                         Pos == "FW,LW" ~ "Attacker",
                         Pos == "LW" ~ "Attacker",
                         Pos == "CM" ~ "Midfielder",
                         Pos == "RW" ~ "Attacker",
                         Pos == "CM,DM" ~ "Midfielder",
                         Pos == "DM,RM" ~ "Midfielder",
                         Pos == "DM" ~ "Midfielder",
                         Pos == "LM" ~ "Midfielder",
                         Pos == "AM,FW" ~ "Attacker",
                         Pos == "FW,AM" ~ "Attacker",
                         Pos == "RW,RM" ~ "Attacker",
                         Pos == "RM,RW" ~ "Midfielder",
                         Pos == "RM,LW" ~ "Midfielder",
                         Pos == "LW,LM" ~ "Attacker",
                         Pos == "LM,LW" ~ "Midfielder",
                         Pos == "RW,FW" ~ "Attacker",
                         Pos == "AM,LM" ~ "Attacker",
                         Pos == "AM" ~ "Attacker",
                         Pos == "DM" ~ "Midfielder",
                         ...
                         Pos == "CB" ~ "Defender",
                         Pos == "RM,FW" ~ "Attacker",
                         Pos == "DM,CM" ~ "Midfielder",
                         Pos == "DM,LW" ~ "Midfielder",
                         Pos == "RM" ~ "Midfielder",
                         Pos == "LM,DM" ~ "Midfielder",
                         Pos == "FW,CB" ~ "Defender",
                         Pos == "CB,RB" ~ "Defender",
                         Pos == "LW,RM" ~ "Attacker",
                         Pos == "LW,FW" ~ "Attacker",
                         Pos == "CM,LM,RM" ~ "Midfielder",
                         Pos == "LM,RB" ~ "Midfielder",
                         Pos == "RM,RW,LW" ~ "Midfielder",
                         Pos == "RM,WB" ~ "Midfielder",
                         Pos == "CM,AM" ~ "Midfielder",
                         Pos == "CB,LM" ~ "Defender",
                         Pos == "WB,LM" ~ "Defender",
                         Pos == "RM,WB" ~ "Midfielder",
                         Pos == "LB,RB" ~ "Defender",
                         Pos == "RM,LM" ~ "Midfielder",
                         Pos == "CB,LB" ~ "Defender",
                         Pos == "LB,CB" ~ "Defender",
                         Pos == "LB,RB" ~ "Defender",
                         Pos == "DF" ~ "Defender",
                         ...
                         Pos == "LB,CM" ~ "Defender",
                         Pos == "LW,AM"~ "Attacker",
                         Pos == "CM,DM,LM" ~ "Midfielder",
                         Pos == "AM,RW" ~ "Attacker",
                         Pos == "WB,RB" ~ "Defender",
                         Pos == "CM,LW" ~ "Midfielder",
                         Pos == "FW,CM" ~ "Attacker",
                         Pos == "AM,LW" ~ "Attacker",
                         Pos == "RW,LW" ~ "Attacker",
                         Pos == "DM,AM" ~ "Midfielder",
                         Pos == "RM,LM,CM" ~ "Midfielder",
                         Pos == "CM,RM" ~ "Midfielder",
                         Pos == "LW,RW" ~ "Midfielder",
                         Pos == "RM,DM" ~ "Midfielder",
                         Pos == "LW,DM" ~ "Midfielder",
                         Pos == "WB,DM" ~ "Defender",
                         Pos == "DM,CB" ~ "Midfielder",
                         Pos == "FW,DM" ~ "Attacker",
                         Pos == "GK" ~ "Keeper",
                         Pos == "RM,CM,CB" ~ "Midfielder",
                         TRUE ~ as.character(Pos))) %>%
                        replace_na(list(Pos = "Substitute")) %>%
                        replace_na(list(Min = 0)) %>%
  select(team_name = Team, Player = Player_Name, shirt = Player_Num, role = Pos, "stats_minutes_played" = Min, image_url = PlayerURL)
...
```{r}
lineupdata <- MD_logos %>%
  select(team_name, Player, image_url, Shirt_Number = shirt, role, Mins_Played = stats_minutes_played) %>%
...
#HomepassPlot1stWD_I <- ggplotly(HomepassPlot1stWD, layerData = 12)
...
HomepassPlotPost1stsubsWD <- plot_passnet_AI(data = plottingData, 
                                        ...
                                        plot_start = firstSub, plot_finish = 100, pitch = "", wrap = "", pressmap = "Yes", logo = "", passes = 4)
...
MatchdayTableLogos <- MatchdayTableLogos %>%
  ...
  mutate(Player = case_when(Player == "Konstantinos Tsimikas" ~ "Kostas Tsimikas",
                            ...
                            Player == "Kristoffer Vassbakk Ajer" ~ "Kristoffer Ajer",
                            Player == "Sergio Reguilon" ~ "Sergio Reguilón",
                            Player == "Pelly-Ruddock Mpanzu" ~ "Pelly Ruddock Mpanzu",
                            Player == "Nicolás Dominguez" ~ "Nicolás Domínguez",
                            #Player == "Jeremy Doku" ~ "Jérémy Doku",
                            #Player == "Mateo Kovačić" ~ "Mateo Kovacic",
 #                           Player == "Maxime Estève" ~ "Maxime Esteve",
...
PassConnections <- PassConnections %>%
  filter(type == "Pass") %>% 
  select(Passer = playerId, Receiver = receiver, Passer_Team = teamId, Passer_URL = player_image_url, Receiver_Team = receiver_team, Receiver_URL = receiver_URL, Successful_Passes, BCs, Key_Passes, EPV = EPVvalue) 

#calculate pass success
PassConnections <- PassConnections %>%
  group_by(Passer, Receiver, Passer_Team, Receiver_Team, Passer_URL, Receiver_URL) %>% 
  summarise(Passes = n(), Successful_Passes = sum(Successful_Passes), Key_Passes = sum(Key_Passes), BCs = sum(BCs), EPV = sum(EPV)) %>% 
  na.omit() %>%
...
PassConnections <- PassConnections %>%
  ...
  filter(Passes >= 5) %>%
  summarise(Passes = sum(Passes), Successful_Passes = sum(Successful_Passes), Pass_Success = mean(Pass_Suc), Key_Passes = sum(Key_Passes), BCs = sum(BCs), EPV = sum(EPV))

#prep for main tables
PassConnectiondata <- PassConnections %>%
  select(Passer_Team, Passer, Passer_URL, Receiver, Receiver_Team, Receiver_URL, 'Attempted Passes' = Passes, 'Successful Passes' = Successful_Passes, 'Pass Success %' = Pass_Success, 'Key Passes' = Key_Passes, EPV)
```

## Column {.flow}
```{r}
#| results: asis
#| label: Home pass connextions tables
...
HomeconvexPlot1stsubs <- TouchPlayerPlot_AI(TouchDataHome,  title = Match_Home,
                                    plot_start = 00, plot_finish = firstSub, color = Color_Home, text_color = Color_Home_Text,
...
DefEPVData <- DefEPVData %>%
  ...
  select(teamId, playerId, EPVvalue, Defensive_Action, outcome, Def_EPV) %>%
...
AwayDefEPVData <- DefEPVData %>%
  ...
  mutate(Percent_of_Attacking_Team_UnSucc = round(Unsuccessful_Def_EPV/HomeEPVFT,3)) 

HomeDefEPVTable <- HomeDefEPVData %>%
    group_by(Player = playerId) %>% 
  summarise(EPV_Faced = sum(Def_EPV), Percent_Attacking_Team_Total_EPV = sum(Percent_of_Attacking_Team_total), Def_EPV_For = sum(Successful_Def_EPV), Percent_EPV_For = sum(Percent_of_Attacking_Team_Succ), Def_EPV_Against = sum(Unsuccessful_Def_EPV), Percent_EPV_Against = sum(Percent_of_Attacking_Team_UnSucc))
...
HomeDefEPVTable_Final <- HomeDefEPVTable %>%
  ...
  grand_summary_rows(columns = c(2,4,6), fns = list("Overall Totals" = ~ sum (., na.rm=TRUE)), fmt = list(~fmt_number(., decimals =3))) %>%
  grand_summary_rows(columns = c(2, 4, 6), fns = list("Overall Average" = ~ mean (., na.rm=TRUE)), fmt = list(~fmt_number(., decimals =3))) %>%
  tab_header(
...
# Calculate average player position
#AwayAverage_PlayerFT <- AwayPPDAHeatMapDataFT %>% 
#  group_by(playerId, player_shirt) %>% 
#  summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
#        na.omit() %>%
#        mutate(x = (100 - x),
...
# Calculate average player position
#Average_Player1Sub <- HomePPDAHeatMapData1sub %>% 
#  group_by(playerId, player_shirt) %>% 
#  summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
#        na.omit() %>%
#        mutate(x = (100 - x),
...
# Calculate average player position
#Average_PlayerP1Sub <- HomePPDAHeatMapDataP1sub %>% 
#  group_by(playerId, player_shirt) %>% 
#  summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
#        na.omit() %>%
#        mutate(x = (100 - x),
...
# Calculate average player position
#AwayAverage_Player1Sub <- AwayPPDAHeatMapData1sub %>% 
#  group_by(playerId, player_shirt) %>% 
#  summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
#        na.omit() %>%
#        mutate(x = (100 - x),
...
# Calculate average player position
#AwayAverage_PlayerP1Sub <- AwayPPDAHeatMapDataP1sub %>% 
#  group_by(playerId, player_shirt) %>% 
#  summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
#        na.omit() %>%
#        mutate(x = (100 - x),
...
# Calculate average player position
#AwayAverage_Player1H <- AwayPPDAHeatMapData1H %>% 
#  group_by(playerId, player_shirt) %>% 
#  summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
#        na.omit() %>%
#        mutate(x = (100 - x),
...
# Calculate average player position
#AwayAverage_Player2H <- AwayPPDAHeatMapData2H %>% 
#  group_by(playerId, player_shirt) %>% 
#  summarise(x = mean(x, na.rm = TRUE), y = mean(y, na.rm = TRUE), events = n()) %>% 
#        na.omit() %>%
#        mutate(x = (100 - x),
