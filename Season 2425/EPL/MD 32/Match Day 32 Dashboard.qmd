---
title: "Match day 32 Season 2425"
...
#set away
Match_Away <- paste0("West Ham")

#set Away color
Color_Away <- paste("#7B2B3A")

#set Away text
Color_Away_Text <- paste("lightblue")

#set away color scale
ColorScale_Away <- paste("ggsci::purple_material") 
