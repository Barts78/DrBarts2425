---
title: "Match Day 29 Season 2425"
...
#Set Home
Match_Home <- paste0("Aston Villa")

#set Home color
Color_Home <- paste("#4A148C")

#set home text color
Color_Home_Text <- paste("ivory")

#set home color scale
ColorScale_Home <- paste("ggsci::purple_material")

#set home color scale con
ColorScale_HomeC <- paste("ggthemes::Purple")

#set match date
Game_date <- paste("19-02-25")
