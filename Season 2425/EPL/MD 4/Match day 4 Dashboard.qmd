...
MatchIdFbref <- paste("https://fbref.com/en/matches/674bfe9e/Liverpool-Nottingham-Forest-September-14-2024-Premier-League") 

#set WhoScored Match page
MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1821088/Live/England-Premier-League-2024-2025-Liverpool-Nottingham-Forest")
...
MD_logos <- MD_lineups %>%
  mutate(Pos = case_when(Pos == "FW" ~ "Attacker",
                         ...
                         Pos == "WB,AM" ~ "Defender",
                         Pos == "RB,RW" ~ "Defender",                                           
                         Pos == "RB,CM,DM" ~ "Defender",
                         Pos == "LW,LM,RW" ~ "Midfielder",
