---
title: "Match Day 20 Season 2425"
...
Vizlocation <- paste0("~/Dropbox/AI LFC data/R files/AI UP/Scripts/Viz Pack/Season 2425/MD20/")

#set away
Match_Away <- paste0("Manchester United")
...
HMOM = paste("Alexis Mac Allister")
AMOM = paste("Diogo Dalot")
...
EPVHeatMapplotFTW <- EPVHeatMapDataFTW %>%
  ...
  #geometrics
  stat_density_2d(aes(level = EPV, fill = after_stat(level)), alpha = 0.3, adjust = 0.3, linewidth = 0.3) +
...
AwayEPVHeatMapplotFTW <- AwayEPVHeatMapDataFTW %>%
  ...
  #geometrics
  stat_density_2d(aes(#level = EPV, 
    fill = after_stat(level)), alpha = 0.3, adjust = 0.3, linewidth = 0.3) +
