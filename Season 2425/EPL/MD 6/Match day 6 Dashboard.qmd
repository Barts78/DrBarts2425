...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 6/")
...
#Set Home
Match_Home <- paste0("Wolverhampton Wanderers")

#set Home color
Color_Home <- paste("#EEB422")

#set home text color
Color_Home_Text <- paste("black")

#set home color scale
ColorScale_Home <- paste("ggsci::amber_material")

#set home color scale con
ColorScale_HomeC <- paste("ggthemes::Orange-Gold")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/f2633f1d/Wolverhampton-Wanderers-Liverpool-September-28-2024-Premier-League") 

#set WhoScored Match page
MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1821108/Live/England-Premier-League-2024-2025-Wolves-Liverpool")
...
HomeDefEPVTable_Final <- HomeDefEPVTable %>%
  ...
  cols_align(align = "right", columns = everything()) %>%
  cols_label_with(fn = ~ janitor::make_clean_names(., case = "title")) %>%
  row_group_order(groups = c("Keeper", "Defender", "Midfielder" 
                             #, "Attacker"
                             )) %>%
  fmt_percent(
    columns = c(4),
