...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 5/")

#set Away
Match_Away <- paste0("Bournemouth")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/32a9539b/Liverpool-Bournemouth-September-21-2024-Premier-League") 

#set WhoScored Match page
MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1821095/Live/England-Premier-League-2024-2025-Liverpool-Bournemouth")
...
MatchSummaryPlayerTableHome <- MatchSummaryPLayerStandardData %>%
  ...
  tab_options(
    ...
    source_notes.font.size = 8,
    table.width = "100%") %>%
  gt_color_rows(columns = c(5, 31), palette = ColorScale_Home, domain = c(0,20)) %>%
  gt_color_rows(columns = c(6, 17, 21, 28), palette = ColorScale_Home, domain = c(0,100)) %>%
  ...
  gt_color_rows(columns = c(22, 23, 24, 26), palette = ColorScale_Home, domain = c(0,20)) %>%
...
MatchSummaryPlayerTableAway <- MatchSummaryPLayerStandardData %>%
  ...
  tab_options(
    ...
    source_notes.font.size = 8,
    table.width = "100%") %>%
  gt_color_rows(columns = c(5, 31), palette = ColorScale_Away, domain = c(0,20)) %>%
  gt_color_rows(columns = c(6, 17, 21, 28), palette = ColorScale_Away, domain = c(0,100)) %>%
  ...
  gt_color_rows(columns = c(22, 23, 24, 26), palette = ColorScale_Away, domain = c(0,20)) %>%
