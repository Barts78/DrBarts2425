...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 7/")
...
#Set Home
Match_Home <- paste0("Crystal Palace")

#set Away color
Color_Home <- paste("#27408B")

#set Away text
Color_Home_Text <- paste("#d3171e")
...
ColorScale_AwayC <- paste("grDevices::Light Grays")

#set match date
Game_date <- paste("05-10-24")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/49ea224b/Crystal-Palace-Liverpool-October-5-2024-Premier-League") 

#set WhoScored Match page
MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1821115/Live/England-Premier-League-2024-2025-Crystal-Palace-Liverpool")

#set match urls path
MatchIdWhoScoredUrls <- paste("/Users/Barts78/Library/CloudStorage/Dropbox/AI lfc data/R files/AI UP/Scripts/Python/WhoScored/match_urls.csv")
...
AwaypassPlot1stWD <- plot_passnet_AI(data = plottingData,  
                                   ...
                                   scale_color = Color_Away_Text,  text_color = Color_Away, subtitle = paste0(Match_Fixture, " 1st Half"),
                                   plot_start = 00, plot_finish = 44, pressmap = "Yes", logo = "", passes = 4)
AwaypassPlot1stWD
```
...
AwaypassPlot2ndWD <- plot_passnet_AI(data = plottingData,  
                                   team_name = Match_Away, scale_stat = "EPV", 
                                   scale_color = Color_Away_Text, text_color = Color_Away,  subtitle = paste0(Match_Fixture, " 2nd Half"),
...
AwaypassPlot1stsubsWD <- plot_passnet_AI(data = plottingData, 
                                   team_name = Match_Away, scale_stat = "EPV", 
                                   scale_color = Color_Away_Text, text_color = Color_Away, subtitle = paste0(Match_Fixture, " To 1st Subs"),
...
AwaypassPlotpost1stsubsWD <- plot_passnet_AI(data = plottingData, 
                                        team_name = Match_Away, scale_stat = "EPV", 
                                        scale_color = Color_Away_Text,  text_color = Color_Away, subtitle = paste0(Match_Fixture, " Post 1st Subs"),
...
AwaypassPlot1SubAtt <- plot_passnet_AI(data = plottingData,
                                      team_name = Match_Away, scale_stat = "EPV", 
                                      scale_color = Color_Away_Text,  text_color = Color_Away, subtitle = paste0(Match_Fixture, " up to 1st Sub"),
...
AwaypassPlotFTAttW <- plot_passnet_AI(data = plottingData,  
                                     team_name = Match_Away, scale_stat = "EPV", 
                                     scale_color = Color_Away_Text,  text_color = Color_Away, subtitle = paste0(Match_Fixture, " By Time Period (Opta data)"),
                                     plot_start = 00, plot_finish = 100, pitch = "Half", pressmap = "Yes", wrap = "Yes", passes = 2)
AwaypassPlotFTAttW
```
...
MatchSummaryPLayerStandardData <- MatchSummaryPLayerStandardData %>%
  select(Team = teamId, role, Name = playerId, Mins = minutes_played, '% of Team Possession' = Possession, `% of Team On Ball Time` = On_Ball_Time, 'Total Shots' = TotalShots, SoT, 'Out Box Shots' = Out_Box_Shots, Goals, xG, xGOT, xA, xT,  'Attempted Passes' = Attempted_Passes, 'Successful Passes' = Successful_Passes, 'Pass Success %' = Pass_Success, Assists, BCs, 'Key Passes' = Key_Passes, `Long Ps`  = Long_Passes, `Final 3rd P` = Final_Third_Passes, `Prog Ps` = Prog_Passes, 'PK Box P' = PK_Box_Passes, `P Received` = Passes_Recieved, `PPs Received` = Prog_Passes_Recieved, `KPs Recieved` = Key_Passes_Recieved, `Recieveing Suc` = Recieving_Suc, `EPV Recieved` = EPV_Recieved, 'EPV created' = TeamEPV, '% of Team EPV' = Team_EPV_P)
...
#  geom_smooth(size = 1.5, colour = Color_Away) +
  geom_line(size = 1.5, colour = Color_Away_Text) +
...
xGLinePlotAway <- Awaydashboard_data %>%
  ...
  #Geometrics
  #plot xg line
  geom_line(aes(x = expandedMinute, y = TotalxG), linewidth = 2, colour = Color_Away_Text) +
  
  #npXg line
  geom_line(aes(x = expandedMinute, y = TotalNPxG), linewidth = 1, colour = Color_Away_Text, linetype = "dashed") +
...
```{r}
#|height: 100%
Away_S_plot <- plot_shot_AI(Awaydashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = AwayHA,  mapName = Match_Away, teamColor = Color_Away_Text, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta")
...
```{r}
#|height: 100%
Away_S_plotW <- plot_shot_AI(Awaydashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = AwayHA,  mapName = Match_Away, teamColor = Color_Away_Text, text_color = Color_Away, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", wrap = "Player")
...
```{r}
#|height: 100%
Away_S_plotWT <- plot_shot_AI(Awaydashboard_data, highlight_goals = TRUE, average_location = FALSE, mapType = AwayHA,  mapName = Match_Away, teamColor = Color_Away_Text, text_color = Color_Away, matchDate = Game_date, matchFixture = Match_Fixture, dataSource = "Opta", wrap = "Time")
