...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 8/")

#set Away
Match_Away <- paste0("Chelsea")
...
MatchIdFbref <- paste("https://fbref.com/en/matches/99b4737c/Liverpool-Chelsea-October-20-2024-Premier-League") 

#set WhoScored Match page
MatchIdWhoScored <- paste("https://www.whoscored.com/Matches/1821136/Live/England-Premier-League-2024-2025-Liverpool-Chelsea")
...
filenamefbref3 <- paste0("~/Dropbox/AI LFC data/data sets/fbref/", GameName, "_", GameWeek, "_Shots_EPL2425.xlsx")

#set data basis for some tables
MD_passing <- read_excel(filenamefbref1)
#MD_possession <- read_excel(filenamefbref2)
MD_shots <- read_excel(filenamefbref3)
...
EPVHeatMapplotFT <- EPVHeatMapDataFT %>%
  ...
  #geometrics
    #plot player positions
  geom_point(data = AwayAverage_PlayerFT, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = Color_Away, stroke = 0.5, alpha = 0.4) +
...
AwayEPVHeatMapplotFT <- AwayEPVHeatMapDataFT %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_PlayerFT, aes(x, y), fill = Color_Home, size = 8, shape = 21, colour = Color_Home, stroke = 0.5, alpha = 0.4) +
...
EPVHeatMapplot1sub <- EPVHeatMapData1sub %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = AwayAverage_Player1Sub, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = Color_Away, stroke = 0.5, alpha = 0.4) +
...
EPVHeatMapplotP1sub <- EPVHeatMapDataP1sub %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = AwayAverage_PlayerP1Sub, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = Color_Away, stroke = 0.5, alpha = 0.4) +
...
AwayEPVHeatMapplot1sub <- AwayEPVHeatMapData1sub %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_Player1Sub, aes(x, y), fill = Color_Home, size = 8, shape = 21, colour = Color_Home, stroke = 0.5, alpha = 0.4) +
...
AwayEPVHeatMapplotP1sub <- AwayEPVHeatMapDataP1sub %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_PlayerP1Sub, aes(x, y), fill = Color_Home, size = 8, shape = 21, colour = Color_Home, stroke = 0.5, alpha = 0.4) +
...
EPVHeatMapplot1H <- EPVHeatMapData1H %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = AwayAverage_Player1H, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = Color_Away, stroke = 0.5, alpha = 0.4) +
...
EPVHeatMapplot2H <- EPVHeatMapData2H %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = AwayAverage_Player2H, aes(x, y), fill = Color_Away, size = 8, shape = 21, colour = Color_Away, stroke = 0.5, alpha = 0.4) +
...
AwayEPVHeatMapplot1H <- AwayEPVHeatMapData1H %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_Player1H, aes(x, y), fill = Color_Home, size = 8, shape = 21, colour = Color_Home, stroke = 0.5, alpha = 0.4) +
...
AwayEPVHeatMapplot2H <- AwayEPVHeatMapData2H %>%
  ...
  #geometrics
  #plot player positions
  geom_point(data = Average_Player2H, aes(x, y), fill = Color_Home, size = 8, shape = 21, colour = Color_Home, stroke = 0.5, alpha = 0.4) +
