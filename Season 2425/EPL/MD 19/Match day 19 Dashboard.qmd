---
title: "Match Day 19 Season 2425"
...
Vizlocation <- paste0("~/Dropbox/AI LFC data/UP Pod Prep 2425/Matchday 17/")
...
#Set Home
Match_Home <- paste0("West Ham United")

#set Home color
Color_Home <- paste("#7B2B3A")

#set home text color
Color_Home_Text <- paste("cadetblue1")
...
#set league points
League_Points <- 45
AFC_League_Points <- 36 
MC_League_Points <- 31

#set man of the match
HMOM = paste("Mohammed Kudus")
AMOM = paste("Alexis Mac Allister")
...
## Row {.flow}
```{r}
#| label: Match Goals Probality Plot
...
```
```{r}
#| label: Match Result Probality Plot
