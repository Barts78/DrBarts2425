---
title: "End of Season Review 2425"
...
Vizlocation <- paste0("~/Documents/Dropbox files/AI LFC data/R files/AI UP/Scripts/Viz Pack/Season 2425/End of season Review/")
...
#set Game name
GameName <- paste("EPL2425GameDatabase_End_of_Season")
...
Dribblesmapdata <- heatmapdata %>%
  ...
  select(TeamName, Team_Group, teamId, playerId, player_shirt, player_image_url, playerNumber, role,  x, y, DribblesFinalX, DribblesFinalY, outcome, Game_Period )
...
Duelsmapdata <- heatmapdata %>%
  ...
  select(TeamName,Team_Group, teamId, playerId, player_shirt, player_image_url, playerNumber, role, x, y, DuelsFinalX, DuelsFinalY, outcome, Game_Period )
